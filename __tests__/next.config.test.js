    ...
    expect(cspRule.headers).toEqual([
      {
        ...
        value:
          "connect-src 'self'  *.nav.no api.uxsignals.com *.boost.ai *.psplugin.com *.puzzel.com *.hotjar.com *.hotjar.io *.skyra.no *.taskanalytics.com; font-src *.psplugin.com *.hotjar.com *.skyra.no cdn.nav.no *.googleapis.com *.gstatic.com data:; script-src *.nav.no widget.uxsignals.com *.psplugin.com *.puzzel.com *.hotjar.com *.skyra.no *.taskanalytics.com nav.boost.ai 'unsafe-inline' 'unsafe-eval'; script-src-elem 'self' *.nav.no widget.uxsignals.com *.psplugin.com *.puzzel.com *.hotjar.com *.skyra.no *.taskanalytics.com nav.boost.ai 'unsafe-inline'; style-src-elem 'self' *.nav.no *.psplugin.com 'unsafe-inline' *.googleapis.com *.gstatic.com; img-src 'self' data: blob: *.nav.no widget.uxsignals.com *.psplugin.com *.vimeocdn.com *.hotjar.com *.skyra.no www.vergic.com; default-src *.nav.no; worker-src *.nav.no blob:; child-src *.nav.no blob:; style-src *.nav.no *.psplugin.com 'unsafe-inline' *.googleapis.com *.gstatic.com; frame-src *.hotjar.com player.vimeo.com video.qbrick.com *.nav.no; frame-ancestors 'self' *.psplugin.com;"
      }
    ]);
