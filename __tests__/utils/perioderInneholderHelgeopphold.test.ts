...
describe('perioderInneholderHelgeopphold', () => {
  it('should return true if perioder contain a weekend gap of 2-3 days between Friday and Monday', () => {
    const perioder = [
      { fom: parseIsoDate('2025-01-06'), tom: parseIsoDate('2025-01-14'), id: '2' },
      { fom: parseIsoDate('2025-01-01'), tom: parseIsoDate('2025-01-03'), id: '1' }
    ];
  ...
  it('should return false if perioder do not contain a weekend gap of 2-3 days between Friday and Monday', () => {
    const perioder = [
      { fom: parseIsoDate('2025-01-05'), tom: parseIsoDate('2025-01-07'), id: '2' },
      { fom: parseIsoDate('2025-01-01'), tom: parseIsoDate('2025-01-02'), id: '1' }
    ];
  ...
  it('should return true if perioder contain a weekend gap of 1 day', () => {
    const perioder = [
      { fom: parseIsoDate('2025-01-05'), tom: parseIsoDate('2025-01-13'), id: '2' },
      { fom: parseIsoDate('2025-01-01'), tom: parseIsoDate('2025-01-03'), id: '1' }
    ];
    expect(perioderInneholderHelgeopphold(perioder)).toBe(true);
  });
  ...
  it('should return false if perioder contain a weekend gap of more than 3 days', () => {
    const perioder = [
      { fom: parseIsoDate('2025-01-03'), tom: parseIsoDate('2025-01-06'), id: '1' },
      { fom: parseIsoDate('2025-01-08'), tom: parseIsoDate('2025-01-10'), id: '2' }
    ];
    expect(perioderInneholderHelgeopphold(perioder)).toBe(false);
  });
  ...
  it('should return false if perioder contain invalid dates', () => {
    const perioder = [
      { fom: undefined, tom: parseIsoDate('2025-01-03'), id: '1' },
      { fom: parseIsoDate('2025-01-06'), tom: undefined, id: '2' }
    ];
    expect(perioderInneholderHelgeopphold(perioder)).toBe(false);
  });
