...
describe('BortfallNaturalytelser', () => {
  ...
  it('renders a text', () => {
    const ytelser: Array<Naturalytelse> = [
      { naturalytelse: 'FRITRANSPORT', sluttdato: new Date(2025, 2, 2), verdiBeloep: 1234.5 },
      { naturalytelse: 'KOSTBESPARELSEIHJEMMET', sluttdato: new Date(2025, 2, 2), verdiBeloep: 1234.5 }
    ];
    render(<BortfallNaturalytelser ytelser={ytelser} />);
