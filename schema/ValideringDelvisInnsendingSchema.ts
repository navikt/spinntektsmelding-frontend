...
export default z
  .object({
    inntekt: z
      .object({
        ingenEndringBruttoloenn: z.enum(['Ja', 'Nei'], {
          error: (_issue) => ({ error: 'Vennligst angi om det har vært endringer i beregnet månedslønn.' })
        }),
    ...
    opplysningerBekreftet: z.boolean().refine((value) => value === true, {
      error: 'Vennligst bekreft at opplysningene er riktige og fullstendige.'
    }),
    refusjon: z
      .object({
        erDetEndringRefusjon: z
          .enum(['Ja', 'Nei'], {
            error: () => 'Vennligst angi om det har vært endringer i refusjonskravet.'
          })
          .optional(),
        kreverRefusjon: z
          .enum(['Ja', 'Nei'], {
        ...
        harEndringer: z
          .enum(['Ja', 'Nei'], {
            error: () => 'Vennligst angi om det er endringer i refusjonsbeløpet.'
          })
          .optional(),
        ...
        kravetOpphoerer: z
          .enum(['Ja', 'Nei'], {
            error: () => 'Vennligst angi om kravet opphører.'
          })
          .optional(),
