...
describe('Delvis skjema - Utfylling og innsending av skjema', () => {
  ...
  it('No changes and submit', () => {
    ...
    cy.findByRole('group', {
      name: 'Har det vært endringer i beregnet månedslønn for den ansatte mellom 02.01.2023 og 24.02.2023 (start av nytt sykefravær)?'
    })
      .findByLabelText('Nei')
      .check();

    cy.findByRole('group', {
      name: 'Har det vært endringer i refusjonskrav mellom 02.01.2023 og 24.02.2023 (start av nytt sykefravær)?'
    })
      .findByLabelText('Nei')
      .check();
    ...
    cy.wait('@innsendingInntektsmelding')
      ...
      .should('deep.equal', {
        ...
        bestemmendeFraværsdag: '2023-02-24',
        refusjon: {
  ...
  it('Changes and submit', () => {
    ...
    cy.findByLabelText('Månedsinntekt 24.02.2023').invoke('val').should('equal', '46 000,00');
    cy.findByLabelText('Månedsinntekt 24.02.2023').clear().type('50000');
