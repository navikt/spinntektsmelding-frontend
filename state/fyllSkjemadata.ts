...
export default function fyllSkjemadata(skjemaData: any) {
  ...
  const innsending = {
    sykmeldtFnr: skjemaData.identitetsnummer,
    avsender: {
      orgnr: skjemaData.orgnrUnderenhet,
      tlf: skjemaData.telefon.value
    },
    ...
    // },
    // aarsakInnsending: 'Ny'
    arbeidsgiverBetalerIArbeidsgiverperioden: skjemaData['lia-radio'],
    bekreftet: skjemaData['bekreft-opplysninger'].checked
  };
